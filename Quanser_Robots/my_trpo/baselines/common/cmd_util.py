...
def common_arg_parser():
    ...
    parser.add_argument('--save_sample_data', default=False, action='store_true')
    parser.add_argument('--expert_data_path', help='Path to expert data from', default='./data/mujoco/', type=str)
    parser.add_argument('--num_trajs', type=float, default=100),
    parser.add_argument('--timesteps', type=float, default=None),
    return parser
