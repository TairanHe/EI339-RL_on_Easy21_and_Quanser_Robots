...
# _ENV_INFO.update({
#     'quanser_qube': {
#         'path': 'mbbl.env.quanser_env.quanser_robots.qube.qube',
#         'ob_size': 6, 'action_size': 1, 'max_length': 500,
#     },
#     'quanser_ball': {
#         'path': 'mbbl.env.quanser_env.quanser_robots.ball_balancer.ball_balancer_sim',
#         'ob_size': 8, 'action_size': 2, 'max_length': 1000,
#     },
#     'quanser_cartpole': {
#         'path': 'mbbl.env.quanser_env.quanser_robots.cartpole.cartpole',
#         'ob_size': 5, 'action_size': 1, 'max_length': 2000,
#     },
# })
_ENV_INFO.update({
    'gym_reacher': {
...
def io_information(task_name):
    ...
    if "quanser" not in task_name:
        return _ENV_INFO[task_name]['ob_size'], \
               _ENV_INFO[task_name]['action_size'], \
               _ENV_INFO[task_name]['max_length']
    else:
        if task_name == "quanser_qube":
            info = {'ob_size': 6, 'action_size': 1, 'max_length': 500}
            return info['ob_size'], \
                   info['action_size'], \
                   info['max_length']
        elif task_name == "quanser_ball":
            info = {'ob_size': 8, 'action_size': 2, 'max_length': 1000}
            return info['ob_size'], \
                   info['action_size'], \
                   info['max_length']
        elif task_name == "quanser_cartpole":
            info = {'ob_size': 5, 'action_size': 1, 'max_length': 2000}
            return info['ob_size'], \
                   info['action_size'], \
                   info['max_length']
